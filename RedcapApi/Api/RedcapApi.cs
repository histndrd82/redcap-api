...
namespace VCU.Redcap
{
    ...
    public class RedcapApi : IRedcap
    {
        ...
        public async Task<string> ImportProjectInfoAsync(string token, Content content, ReturnFormat format, RedcapProjectDetail projectInfo)
        {
            try
            {
                /*
        ...
        /// </param>
        /// <returns>Returns the number of values accepted to be updated in the project settings (including values which remained the same before and after the import).</returns>
        public async Task<string> ImportProjectInfoAsync(string token, ReturnFormat format, RedcapProjectDetail projectInfo)
        {
            try
            {
                /*
